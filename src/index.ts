...
program
  ...
  .option('-p, --provider <name>', 'Provider name (mindbody, equinox, classpass, soulcycle, barrys, orangetheory, corepoweryoga, f45, planetfitness, lafitness, goldsgym, or all)')
